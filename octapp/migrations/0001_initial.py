# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-04-24 09:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('divisions_layout', models.CharField(help_text="например, для 2-бальной шкалы (зачтено, незачтено) разметка делений может быть <q>'40,60'</q>", max_length=20, verbose_name='Разметка делений шкалы -- процентные доли каждого деления через запятую')),
            ],
            options={
