...
class TestForm(forms.ModelForm):
    new_category = forms.CharField(
        ...
        widget=TextInput(attrs={'title': 'Допускается использовать строчные буквы, цифры, дефис и /', 'placeholder': 'Допускается использовать строчные буквы, цифры, дефис и /', 'pattern': '[ a-zа-яё0-9 -/]+'}),
    ...
    new_tags = forms.CharField(
        ...
        required=False,
        widget=TextInput(attrs={'title': 'Допускается использовать строчные и заглавные буквы, цифры, запятые, дефис и /', 'placeholder': 'Допускается использовать строчные и заглавные буквы, цифры, запятые, дефис и /', 'pattern': '[ a-zA-Zа-яёА-Я0-9 -/,]+'}),
